...
<div class="box-left-home">
    ...
    <div>
        ...
        <table class="table-detail">
            ...
            <tr>
                <th>Loại truy nã</th>
                <td colspan="3"><input size="50" type="loaitruyna" name="loaitruyna" id="loaitruyna" class="form-control input-md"></td>

            </tr>
            <tr>
                <th>Quyết định truy nã</th>
                <td colspan="3"><input size="50" type="quyetdinhtruyna" name="quyetdinhtruyna" id="quyetdinhtruyna" class="form-control input-md"></td>

            </tr>
            <tr>
                <th>Đơn vị ra quyết định</th>
                <td colspan="3"><input size="50" type="donviraquyetdinh" name="donviraquyetdinh" id="donviraquyetdinh" class="form-control input-md"></td>
